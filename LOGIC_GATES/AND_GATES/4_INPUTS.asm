...
INPUT_C				EQU		2				   ; INPUT_B IS RB1 (BIT 2)
INPUT_D				EQU		3				   ; INPUT_B IS RB1 (BIT 3)
...
; TEST INPUTS
TEST_INPUTS:
                    BTFSS   PORTB, INPUT_A    ; TEST INPUT_A (RB0)
                    GOTO    CLEAR_OUT         ; GOTO CLEAR_OUT
                    BTFSS   PORTB, INPUT_B    ; TEST INPUT_B (RB1)
                    GOTO    CLEAR_OUT         ; GOTO CLEAR_OUT
                    BTFSS   PORTB, INPUT_C    ; TEST INPUT_A (RB2)
                    GOTO    CLEAR_OUT         ; GOTO CLEAR_OUT
					BTFSS   PORTB, INPUT_D    ; TEST INPUT_A (RB3)
                    GOTO    CLEAR_OUT         ; GOTO CLEAR_OUT
