...
; THIS IS A 4-INPUT XOR GATE TESTING FOR ALL CONDITIONS WHEN OUTPUT IS 1
;******************************************************************
...
CASE_4:
                    ...
                    BTFSC   PORTB, INPUT_C    ; CHECK IF INPUT_C IS 0
                    GOTO    CASE_5            ; GOTO TO CASE 5
                    BTFSC   PORTB, INPUT_D    ; CHECK IF INPUT_D IS NOT 1
                    GOTO    SET_OUT           ; IF TRUE, SET THE OUTPUT
                    GOTO    CASE_5            ; GOTO TO CASE 5

CASE_5:
                    ; CASE 5: IF INPUT_A, INPUT_B, AND INPUT_C ARE 1
                    BTFSS   PORTB, INPUT_A    ; CHECK IF INPUT_A IS 1
...
CASE_6:
                    ; CASE 6: IF INPUT_A, INPUT_B, AND INPUT_D ARE 1
                    BTFSS   PORTB, INPUT_A    ; CHECK IF INPUT_A IS 1
...
CASE_7:
                    ; CASE 7: IF INPUT_A, INPUT_C, AND INPUT_D ARE 1
                    BTFSS   PORTB, INPUT_A    ; CHECK IF INPUT_A IS 1
...
CASE_8:
                    ; CASE 8: IF INPUT_B, INPUT_C, AND INPUT_D ARE 1
                    BTFSS   PORTB, INPUT_A    ; CHECK IF INPUT_A IS 0
